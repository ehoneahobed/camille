/** Hairline icons — matches prototype/src/icons.jsx */

export function IconArrow({ size = 14, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconMic({ size = 16, className }: { size?: number; className?: string }) {
  return (
    <svg
      width={size}
      height={size}
